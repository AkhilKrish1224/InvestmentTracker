                    ...
                    <table class="table table-hover">
                      ...
                      <?php 
                        if($name=="admin")
                        {
                                    ...
                                    $que = "SELECT email,username from user"; 
                                    $que_run = mysqli_query($con, $que);
                                    if(mysqli_num_rows($que_run) != 0)
                                    {
                                        foreach($que_run as $item)
                                        {
                                            ?>
                                            ...
                                            <?php
                                            $testmail=$item['email'];
                                            $query = "SELECT sum(total) FROM invsm where email='$testmail' group by symbol";
                                            $query1 = "SELECT Amount FROM invfd where email='$testmail' group by Name";
                                            ...
                                            if(mysqli_num_rows($query_run1) != 0)
                                            {
                                                ...
                                                <td ><?= $item['email']; ?></td>
                                                <td ><?= $inv;?></td> -->
                                                <td ><input type="text" id="name1" name="name1" value="<?= $item['username']; ?>" style="border:0px" readonly></td>
                                                <td ><input type="text" id="name2" name="name2" value="<?= $item['email']; ?>" style="border:0px" readonly></td>
